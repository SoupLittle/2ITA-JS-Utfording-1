...
//   String : ["Programmer","Designer","Gamer"],
//   typeSpeed : 150,
//   backSpeed : 150,
//   loop: true, 
// })
...
var words = ["Programmer", "Designer", "Gamer"]
var wordIndex = 0
var letterIndex = 0
var speed = 100
...
function typeWriter(){
  if(letterIndex < words[wordIndex].length){
    document.getElementById('auto-type').innerHTML += words[wordIndex].charAt(letterIndex)
      letterIndex++
...
function eraseText(){
  if(letterIndex > 0){
    ...
    document.getElementById('auto-type').innerHTML = currentWord.substring(0, letterIndex - 1)
    letterIndex--
